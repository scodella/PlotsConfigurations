...
if 'VetoHEM' in opt.tag:
    ...
    # ... and then the real validation and signal regions
        ...
        if 'ValidationRegion' in opt.tag:
            ...
            if hasattr(opt, 'outputDirDatacard') or hasattr(opt, 'combineAction') or hasattr(opt, '--skipBOnlyFit') or hasattr(opt, 'prefitSignal'):
                del variables['mt2ll']
	    ...
	    if 'ZZValidationRegion' in opt.tag or 'ttZValidationRegion' in opt.tag or 'DYValidationRegion' in opt.tag or 'WZtoWWValidationRegion' in opt.tag or 'WZValidationRegion' in opt.tag or 'FakeValidationRegion' in opt.tag:
                ...
                elif 'WZtoWWValidationRegionXXX' in opt.tag:
            ...
            if not hasattr(opt, 'outputDirDatacard') and not hasattr(opt, 'combineAction') and not hasattr(opt, '--skipBOnlyFit') and not hasattr(opt, 'prefitSignal'):
